...
- Corrected source `1ad2031` passed five fresh integrated `--enforce-budgets` processes on each approved host. Apple executable `9d9941e3a14c7acdea71c8c28c4af215a77a7f143d4cc793a53ef2d1d4d3e1da` and Windows executable `cce21732cc7afb5b9c4903b95f732c42e725e7c92591845f6a39482be0ea5504` passed every accepted gate without retry or exclusion; hosted checks passed both release targets.
