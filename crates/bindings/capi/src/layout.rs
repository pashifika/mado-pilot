...
use crate::types::{
    madopilot_build_info_t, madopilot_error_detail_t, madopilot_find_request_t,
    madopilot_frame_info_t, madopilot_frame_stamp_t, madopilot_image_t, madopilot_map_request_t,
    madopilot_match_options_t, madopilot_match_t, madopilot_open_request_t, madopilot_operation_t,
    madopilot_package_info_t, madopilot_package_source_t, madopilot_pixel_rect_t,
