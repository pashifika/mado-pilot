...
use crate::ocr::{madopilot_ocr_result_t, madopilot_ocr_zone_scan_result_t};
...
use crate::types::{
    ...
    madopilot_ocr_provider_descriptor_t, madopilot_ocr_provider_options_t, madopilot_ocr_region_t,
    madopilot_ocr_request_t, madopilot_ocr_requested_region_t, madopilot_ocr_result_info_t,
