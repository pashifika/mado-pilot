...
int main(int argc, char** argv)
{
    ...
    printf("frozen header: abi %u.%u, table %u bytes as v1_2 declared it\n",
    ...
    if (failures != 0) {
        printf("madopilot-abi-compat-v1_2 failed %d check(s)\n", failures);
        return 1;
    }

    printf("madopilot-abi-compat-v1_2 complete\n");
    return 0;
}
