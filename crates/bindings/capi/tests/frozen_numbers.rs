...
frozen! {
    ...
    MADOPILOT_DIAGNOSTIC_RECORD_HAS_CANDIDATE_COUNT = 0x2000,
    MADOPILOT_DIAGNOSTIC_RECORD_HAS_INPUT_EVENT_DETAIL = 0x4000,
    MADOPILOT_DIAGNOSTIC_INPUT_EVENT_REVALIDATION_MASK = 0x0000ffff,
    MADOPILOT_DIAGNOSTIC_INPUT_EVENT_GEOMETRY_MASK = 0xffff0000,
    MADOPILOT_DIAGNOSTIC_INPUT_EVENT_GEOMETRY_SHIFT = 16,
